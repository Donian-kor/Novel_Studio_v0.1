...
class PlanningView(BaseView):
    def __init__(self, w):
        ...
        self.diffMasterBtn = self.ui.findChild(QPushButton, 'diffMasterBtn')
    ...
    def _b(self, n):
        return self.ui.findChild(QPushButton, n)

    @property
    def masterBtn(self):
        return self._b('masterBtn')

    @property
    def contractBtn(self):
        return self._b('contractBtn')

    @property
    def lockBtn(self):
        return self._b('lockBtn')

    @property
    def masterPlotBtn(self):
        return self._b('masterPlotBtn')
