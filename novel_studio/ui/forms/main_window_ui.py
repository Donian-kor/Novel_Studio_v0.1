...
class Ui_MainWidget(object):
    def setupUi(self, MainWidget):
        ...
        self.leftHandle.setMinimumSize(QSize(40, 0))
        self.leftHandle.setMaximumSize(QSize(40, 16777215))
        ...
        sizePolicy.setHeightForWidth(self.leftExpand.sizePolicy().hasHeightForWidth())
        self.leftExpand.setSizePolicy(sizePolicy)
        self.leftExpand.setMinimumSize(QSize(0, 48))
        ...
        self.rightHandle.setMinimumSize(QSize(40, 0))
        self.rightHandle.setMaximumSize(QSize(40, 16777215))
        self.rh = QVBoxLayout(self.rightHandle)
        self.rh.setObjectName(u"rh")
        self.rh.setContentsMargins(0, 0, 0, 0)
        self.rightExpand = QPushButton(self.rightHandle)
        self.rightExpand.setObjectName(u"rightExpand")
        sizePolicy.setHeightForWidth(self.rightExpand.sizePolicy().hasHeightForWidth())
        self.rightExpand.setSizePolicy(sizePolicy)
        self.rightExpand.setMinimumSize(QSize(0, 48))
...
#if QT_CONFIG(tooltip)
        self.leftExpand.setToolTip(QCoreApplication.translate("MainWidget", u"\uc67c\ucabd \uc0ac\uc774\ub4dc\ubc14 \ud3bc\uce58\uae30", None))
#endif // QT_CONFIG(tooltip)
        self.leftExpand.setText(QCoreApplication.translate("MainWidget", u"\u25b6", None))
#if QT_CONFIG(tooltip)
        self.rightExpand.setToolTip(QCoreApplication.translate("MainWidget", u"\uc624\ub978\ucabd \uc0ac\uc774\ub4dc\ubc14 \ud3bc\uce58\uae30", None))
#endif // QT_CONFIG(tooltip)
